...
import core.Core;                       //
import core.ProximityDriver;          // <- these lines must be uncommented
...
//------------------------------------------------------------------------
//placeholder Driver INTERFACE
//class ProximityTransport{
//    public ProximityTransport(String protocolName) {
//    }
//
//    public boolean handleFoundPeer(String peerID){
//        return true;
//    }
//    public boolean handleLostPeer(String peerID){
//        System.out.println("Lost peer :: "+peerID);
//        return false;
//    }
//    public boolean receiveFromPeer(String peerID, byte[] payload){
//        return true;

//    }
//    public boolean log(int level,String peerID){
...
public class BleInterface implements ProximityDriver {
    ...
    public void start(String localPID) {
        ...
        mTransport = Core.getProximityTransport(ProtocolName); // <- Uncomment
        if (mTransport == null) {
